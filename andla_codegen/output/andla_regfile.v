...
,ldma_base_addr_select
,cdma_base_addr_select
,sdma_base_addr_select
...
// autogen_io_start
output	 [CSR_EXRAM_BASED_ADDR_0_BITWIDTH-1:0] rf_csr_exram_based_addr_0;
output	 [CSR_EXRAM_BASED_ADDR_1_BITWIDTH-1:0] rf_csr_exram_based_addr_1;
output	 [CSR_EXRAM_BASED_ADDR_2_BITWIDTH-1:0] rf_csr_exram_based_addr_2;
output	 [CSR_EXRAM_BASED_ADDR_3_BITWIDTH-1:0] rf_csr_exram_based_addr_3;
output	 [CSR_EXRAM_BASED_ADDR_4_BITWIDTH-1:0] rf_csr_exram_based_addr_4;
output	 [CSR_EXRAM_BASED_ADDR_5_BITWIDTH-1:0] rf_csr_exram_based_addr_5;
output	 [CSR_EXRAM_BASED_ADDR_6_BITWIDTH-1:0] rf_csr_exram_based_addr_6;
output	 [CSR_EXRAM_BASED_ADDR_7_BITWIDTH-1:0] rf_csr_exram_based_addr_7;
...
output [SDMA_BASE_ADDR_SELECT_BITWIDTH-           1:0] sdma_base_addr_select;
output [CDMA_BASE_ADDR_SELECT_BITWIDTH-           1:0] cdma_base_addr_select;
output [LDMA_BASE_ADDR_SELECT_BITWIDTH-           1:0] ldma_base_addr_select;
...
assign rf_csr_exram_based_addr_0            =  {csr_exram_based_addr_0_msb_reg, csr_exram_based_addr_0_lsb_reg};
assign rf_csr_exram_based_addr_1            =  {csr_exram_based_addr_1_msb_reg, csr_exram_based_addr_1_lsb_reg};
assign rf_csr_exram_based_addr_2            =  {csr_exram_based_addr_2_msb_reg, csr_exram_based_addr_2_lsb_reg};
assign rf_csr_exram_based_addr_3            =  {csr_exram_based_addr_3_msb_reg, csr_exram_based_addr_3_lsb_reg};
assign rf_csr_exram_based_addr_4            =  {csr_exram_based_addr_4_msb_reg, csr_exram_based_addr_4_lsb_reg};
assign rf_csr_exram_based_addr_5            =  {csr_exram_based_addr_5_msb_reg, csr_exram_based_addr_5_lsb_reg};
assign rf_csr_exram_based_addr_6            =  {csr_exram_based_addr_6_msb_reg, csr_exram_based_addr_6_lsb_reg};
assign rf_csr_exram_based_addr_7            =  {csr_exram_based_addr_7_msb_reg, csr_exram_based_addr_7_lsb_reg};
assign rf_sdma_direction                    =  sdma_direction_reg;
assign rf_sdma_exram_addr                   =  {sdma_exram_addr_msb_reg, sdma_exram_addr_lsb_reg};
...
assign rf_ldma_exram_addr                   =  {ldma_exram_addr_msb_reg, ldma_exram_addr_lsb_reg};
