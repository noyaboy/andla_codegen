...
// autogen_start
    ...
    reg_file->item[FME0].reg[FME0_IM_DILATED_RATE].phy_addr                       = &(andla_fme0_reg_p->im_dilated_rate);
    ...
    reg_file->item[FME0].reg[FME0_EM_ALIGNMENT_ICIW].phy_addr                     = &(andla_fme0_reg_p->em_alignment_iciw);
    ...
    reg_file->item[FME0].reg[FME0_IM_KC].phy_addr                                 = &(andla_fme0_reg_p->im_kc);
