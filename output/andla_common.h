...
reg_file->item[CSR].reg[CSR_EXRAM_BASED_ADDR_0_LSB].phy_addr         = &(andla_csr_reg_p->exram_based_addr_0_lsb);
...
reg_file->item[CSR].reg[CSR_EXRAM_BASED_ADDR_0_MSB].phy_addr         = &(andla_csr_reg_p->exram_based_addr_0_msb);
...
reg_file->item[CSR].reg[CSR_EXRAM_BASED_ADDR_1_LSB].phy_addr         = &(andla_csr_reg_p->exram_based_addr_1_lsb);
...
reg_file->item[CSR].reg[CSR_EXRAM_BASED_ADDR_1_MSB].phy_addr         = &(andla_csr_reg_p->exram_based_addr_1_msb);
...
reg_file->item[CSR].reg[CSR_EXRAM_BASED_ADDR_2_LSB].phy_addr         = &(andla_csr_reg_p->exram_based_addr_2_lsb);
...
reg_file->item[CSR].reg[CSR_EXRAM_BASED_ADDR_2_MSB].phy_addr         = &(andla_csr_reg_p->exram_based_addr_2_msb);
...
reg_file->item[CSR].reg[CSR_EXRAM_BASED_ADDR_3_LSB].phy_addr         = &(andla_csr_reg_p->exram_based_addr_3_lsb);
...
reg_file->item[CSR].reg[CSR_EXRAM_BASED_ADDR_3_MSB].phy_addr         = &(andla_csr_reg_p->exram_based_addr_3_msb);
...
reg_file->item[CSR].reg[CSR_EXRAM_BASED_ADDR_4_LSB].phy_addr         = &(andla_csr_reg_p->exram_based_addr_4_lsb);
...
reg_file->item[CSR].reg[CSR_EXRAM_BASED_ADDR_4_MSB].phy_addr         = &(andla_csr_reg_p->exram_based_addr_4_msb);
...
reg_file->item[CSR].reg[CSR_EXRAM_BASED_ADDR_5_LSB].phy_addr         = &(andla_csr_reg_p->exram_based_addr_5_lsb);
...
reg_file->item[CSR].reg[CSR_EXRAM_BASED_ADDR_5_MSB].phy_addr         = &(andla_csr_reg_p->exram_based_addr_5_msb);
...
reg_file->item[CSR].reg[CSR_EXRAM_BASED_ADDR_6_LSB].phy_addr         = &(andla_csr_reg_p->exram_based_addr_6_lsb);
...
reg_file->item[CSR].reg[CSR_EXRAM_BASED_ADDR_6_MSB].phy_addr         = &(andla_csr_reg_p->exram_based_addr_6_msb);
...
reg_file->item[CSR].reg[CSR_EXRAM_BASED_ADDR_7_LSB].phy_addr         = &(andla_csr_reg_p->exram_based_addr_7_lsb);
...
reg_file->item[CSR].reg[CSR_EXRAM_BASED_ADDR_7_MSB].phy_addr         = &(andla_csr_reg_p->exram_based_addr_7_msb);
reg_file->item[CSR].reg[CSR_NOP].bitwidth                            = 22;
reg_file->item[CSR].reg[CSR_NOP].index                               = CSR_NOP;
reg_file->item[CSR].reg[CSR_NOP].phy_addr                            = &(andla_csr_reg_p->nop);
reg_file->item[SDMA].reg[SDMA_SFENCE].bitwidth                       = 22;
reg_file->item[SDMA].reg[SDMA_SFENCE].index                          = SDMA_SFENCE;
reg_file->item[SDMA].reg[SDMA_SFENCE].phy_addr                       = &(andla_sdma_reg_p->sfence);
reg_file->item[SDMA].reg[SDMA_DIRECTION].bitwidth                    = 0;
reg_file->item[SDMA].reg[SDMA_DIRECTION].index                       = SDMA_DIRECTION;
reg_file->item[SDMA].reg[SDMA_DIRECTION].phy_addr                    = &(andla_sdma_reg_p->direction);
...
reg_file->item[SDMA].reg[SDMA_EXRAM_ADDR_LSB].phy_addr               = &(andla_sdma_reg_p->exram_addr_lsb);
...
reg_file->item[SDMA].reg[SDMA_EXRAM_STRIDE_W_SIZE].phy_addr          = &(andla_sdma_reg_p->exram_stride_w_size);
...
reg_file->item[SDMA].reg[SDMA_EXRAM_STRIDE_H_SIZE].phy_addr          = &(andla_sdma_reg_p->exram_stride_h_size);
...
reg_file->item[SDMA].reg[SDMA_SHRAM_PAD_RIGHT].phy_addr              = &(andla_sdma_reg_p->shram_pad_right);
...
reg_file->item[SDMA].reg[SDMA_SHRAM_PAD_LEFT].phy_addr               = &(andla_sdma_reg_p->shram_pad_left);
reg_file->item[SDMA].reg[SDMA_SHRAM_PAD_UP].bitwidth                 = 4;
reg_file->item[SDMA].reg[SDMA_SHRAM_PAD_UP].index                    = SDMA_SHRAM_PAD_UP;
reg_file->item[SDMA].reg[SDMA_SHRAM_PAD_UP].phy_addr                 = &(andla_sdma_reg_p->shram_pad_up);
...
reg_file->item[SDMA].reg[SDMA_SHRAM_PAD_DOWN].phy_addr               = &(andla_sdma_reg_p->shram_pad_down);
reg_file->item[SDMA].reg[SDMA_CONST_VALUE].bitwidth                  = 16;
reg_file->item[SDMA].reg[SDMA_CONST_VALUE].index                     = SDMA_CONST_VALUE;
reg_file->item[SDMA].reg[SDMA_CONST_VALUE].phy_addr                  = &(andla_sdma_reg_p->const_value);
reg_file->item[SDMA].reg[SDMA_CH_NUM].bitwidth                       = 20;
reg_file->item[SDMA].reg[SDMA_CH_NUM].index                          = SDMA_CH_NUM;
reg_file->item[SDMA].reg[SDMA_CH_NUM].phy_addr                       = &(andla_sdma_reg_p->ch_num);
...
reg_file->item[SDMA].reg[SDMA_SDMA_CHSUM_SEL].phy_addr               = &(andla_sdma_reg_p->sdma_chsum_sel);
...
reg_file->item[SDMA].reg[SDMA_SDMA_CHSUM_DATA].phy_addr              = &(andla_sdma_reg_p->sdma_chsum_data);
reg_file->item[SDMA].reg[SDMA_SHRAM_STRIDE_W_SIZE].bitwidth          = 10;
reg_file->item[SDMA].reg[SDMA_SHRAM_STRIDE_W_SIZE].index             = SDMA_SHRAM_STRIDE_W_SIZE;
reg_file->item[SDMA].reg[SDMA_SHRAM_STRIDE_W_SIZE].phy_addr          = &(andla_sdma_reg_p->shram_stride_w_size);
reg_file->item[SDMA].reg[SDMA_SHRAM_STRIDE_H_SIZE].bitwidth          = 10;
reg_file->item[SDMA].reg[SDMA_SHRAM_STRIDE_H_SIZE].index             = SDMA_SHRAM_STRIDE_H_SIZE;
reg_file->item[SDMA].reg[SDMA_SHRAM_STRIDE_H_SIZE].phy_addr          = &(andla_sdma_reg_p->shram_stride_h_size);
reg_file->item[SDMA].reg[SDMA_SHRAM_STRIDE_N_SIZE].bitwidth          = 10;
reg_file->item[SDMA].reg[SDMA_SHRAM_STRIDE_N_SIZE].index             = SDMA_SHRAM_STRIDE_N_SIZE;
reg_file->item[SDMA].reg[SDMA_SHRAM_STRIDE_N_SIZE].phy_addr          = &(andla_sdma_reg_p->shram_stride_n_size);
reg_file->item[LDMA].reg[LDMA_SFENCE].bitwidth                       = 22;
reg_file->item[LDMA].reg[LDMA_SFENCE].index                          = LDMA_SFENCE;
reg_file->item[LDMA].reg[LDMA_SFENCE].phy_addr                       = &(andla_ldma_reg_p->sfence);
reg_file->item[LDMA].reg[LDMA_DIRECTION].bitwidth                    = 0;
reg_file->item[LDMA].reg[LDMA_DIRECTION].index                       = LDMA_DIRECTION;
reg_file->item[LDMA].reg[LDMA_DIRECTION].phy_addr                    = &(andla_ldma_reg_p->direction);
...
reg_file->item[LDMA].reg[LDMA_EXRAM_ADDR_LSB].phy_addr               = &(andla_ldma_reg_p->exram_addr_lsb);
...
reg_file->item[LDMA].reg[LDMA_EXRAM_STRIDE_W_SIZE].phy_addr          = &(andla_ldma_reg_p->exram_stride_w_size);
...
reg_file->item[LDMA].reg[LDMA_EXRAM_STRIDE_H_SIZE].phy_addr          = &(andla_ldma_reg_p->exram_stride_h_size);
...
reg_file->item[LDMA].reg[LDMA_SHRAM_PAD_RIGHT].phy_addr              = &(andla_ldma_reg_p->shram_pad_right);
...
reg_file->item[LDMA].reg[LDMA_SHRAM_PAD_LEFT].phy_addr               = &(andla_ldma_reg_p->shram_pad_left);
reg_file->item[LDMA].reg[LDMA_SHRAM_PAD_UP].bitwidth                 = 4;
reg_file->item[LDMA].reg[LDMA_SHRAM_PAD_UP].index                    = LDMA_SHRAM_PAD_UP;
reg_file->item[LDMA].reg[LDMA_SHRAM_PAD_UP].phy_addr                 = &(andla_ldma_reg_p->shram_pad_up);
...
reg_file->item[LDMA].reg[LDMA_SHRAM_PAD_DOWN].phy_addr               = &(andla_ldma_reg_p->shram_pad_down);
reg_file->item[LDMA].reg[LDMA_CONST_VALUE].bitwidth                  = 16;
reg_file->item[LDMA].reg[LDMA_CONST_VALUE].index                     = LDMA_CONST_VALUE;
reg_file->item[LDMA].reg[LDMA_CONST_VALUE].phy_addr                  = &(andla_ldma_reg_p->const_value);
reg_file->item[LDMA].reg[LDMA_CH_NUM].bitwidth                       = 20;
reg_file->item[LDMA].reg[LDMA_CH_NUM].index                          = LDMA_CH_NUM;
reg_file->item[LDMA].reg[LDMA_CH_NUM].phy_addr                       = &(andla_ldma_reg_p->ch_num);
...
reg_file->item[LDMA].reg[LDMA_LDMA_DECOMP_PADDING_BY_PASS].phy_addr  = &(andla_ldma_reg_p->ldma_decomp_padding_by_pass);
reg_file->item[LDMA].reg[LDMA_RAM_PADDING_VALUE].bitwidth            = 16;
reg_file->item[LDMA].reg[LDMA_RAM_PADDING_VALUE].index               = LDMA_RAM_PADDING_VALUE;
reg_file->item[LDMA].reg[LDMA_RAM_PADDING_VALUE].phy_addr            = &(andla_ldma_reg_p->ram_padding_value);
reg_file->item[LDMA].reg[LDMA_PAD_C_FRONT].bitwidth                  = 14;
reg_file->item[LDMA].reg[LDMA_PAD_C_FRONT].index                     = LDMA_PAD_C_FRONT;
reg_file->item[LDMA].reg[LDMA_PAD_C_FRONT].phy_addr                  = &(andla_ldma_reg_p->pad_c_front);
reg_file->item[LDMA].reg[LDMA_PAD_C_BACK].bitwidth                   = 14;
reg_file->item[LDMA].reg[LDMA_PAD_C_BACK].index                      = LDMA_PAD_C_BACK;
reg_file->item[LDMA].reg[LDMA_PAD_C_BACK].phy_addr                   = &(andla_ldma_reg_p->pad_c_back);
...
reg_file->item[LDMA].reg[LDMA_LDMA_CHSUM_SEL].phy_addr               = &(andla_ldma_reg_p->ldma_chsum_sel);
...
reg_file->item[LDMA].reg[LDMA_LDMA_CHSUM_DATA].phy_addr              = &(andla_ldma_reg_p->ldma_chsum_data);
reg_file->item[LDMA].reg[LDMA_SHRAM_STRIDE_W_SIZE].bitwidth          = 10;
reg_file->item[LDMA].reg[LDMA_SHRAM_STRIDE_W_SIZE].index             = LDMA_SHRAM_STRIDE_W_SIZE;
reg_file->item[LDMA].reg[LDMA_SHRAM_STRIDE_W_SIZE].phy_addr          = &(andla_ldma_reg_p->shram_stride_w_size);
reg_file->item[LDMA].reg[LDMA_SHRAM_STRIDE_H_SIZE].bitwidth          = 10;
reg_file->item[LDMA].reg[LDMA_SHRAM_STRIDE_H_SIZE].index             = LDMA_SHRAM_STRIDE_H_SIZE;
reg_file->item[LDMA].reg[LDMA_SHRAM_STRIDE_H_SIZE].phy_addr          = &(andla_ldma_reg_p->shram_stride_h_size);
reg_file->item[LDMA].reg[LDMA_SHRAM_STRIDE_N_SIZE].bitwidth          = 10;
reg_file->item[LDMA].reg[LDMA_SHRAM_STRIDE_N_SIZE].index             = LDMA_SHRAM_STRIDE_N_SIZE;
reg_file->item[LDMA].reg[LDMA_SHRAM_STRIDE_N_SIZE].phy_addr          = &(andla_ldma_reg_p->shram_stride_n_size);
reg_file->item[FME0].reg[FME0_SFENCE].bitwidth                       = 0;
reg_file->item[FME0].reg[FME0_SFENCE].index                          = FME0_SFENCE;
reg_file->item[FME0].reg[FME0_SFENCE].phy_addr                       = &(andla_fme0_reg_p->sfence);
reg_file->item[FME0].reg[FME0_MODE].bitwidth                         = 2;
reg_file->item[FME0].reg[FME0_MODE].index                            = FME0_MODE;
reg_file->item[FME0].reg[FME0_MODE].phy_addr                         = &(andla_fme0_reg_p->mode);
reg_file->item[FME0].reg[FME0_RESERVE2].bitwidth                     = 0;
reg_file->item[FME0].reg[FME0_RESERVE2].index                        = FME0_RESERVE2;
reg_file->item[FME0].reg[FME0_RESERVE2].phy_addr                     = &(andla_fme0_reg_p->reserve2);
reg_file->item[FME0].reg[FME0_IM_PAD].bitwidth                       = 5;
reg_file->item[FME0].reg[FME0_IM_PAD].index                          = FME0_IM_PAD;
reg_file->item[FME0].reg[FME0_IM_PAD].phy_addr                       = &(andla_fme0_reg_p->im_pad);
reg_file->item[FME0].reg[FME0_IM_IW].bitwidth                        = 14;
reg_file->item[FME0].reg[FME0_IM_IW].index                           = FME0_IM_IW;
reg_file->item[FME0].reg[FME0_IM_IW].phy_addr                        = &(andla_fme0_reg_p->im_iw);
reg_file->item[FME0].reg[FME0_IM_IH].bitwidth                        = 14;
reg_file->item[FME0].reg[FME0_IM_IH].index                           = FME0_IM_IH;
reg_file->item[FME0].reg[FME0_IM_IH].phy_addr                        = &(andla_fme0_reg_p->im_ih);
reg_file->item[FME0].reg[FME0_IM_IC].bitwidth                        = 14;
reg_file->item[FME0].reg[FME0_IM_IC].index                           = FME0_IM_IC;
reg_file->item[FME0].reg[FME0_IM_IC].phy_addr                        = &(andla_fme0_reg_p->im_ic);
reg_file->item[FME0].reg[FME0_IM_STRIDE].bitwidth                    = 5;
reg_file->item[FME0].reg[FME0_IM_STRIDE].index                       = FME0_IM_STRIDE;
reg_file->item[FME0].reg[FME0_IM_STRIDE].phy_addr                    = &(andla_fme0_reg_p->im_stride);
reg_file->item[FME0].reg[FME0_IM_KERNEL].bitwidth                    = 9;
reg_file->item[FME0].reg[FME0_IM_KERNEL].index                       = FME0_IM_KERNEL;
reg_file->item[FME0].reg[FME0_IM_KERNEL].phy_addr                    = &(andla_fme0_reg_p->im_kernel);
reg_file->item[FME0].reg[FME0_IM_KERNEL_KWKH].bitwidth               = 18;
reg_file->item[FME0].reg[FME0_IM_KERNEL_KWKH].index                  = FME0_IM_KERNEL_KWKH;
reg_file->item[FME0].reg[FME0_IM_KERNEL_KWKH].phy_addr               = &(andla_fme0_reg_p->im_kernel_kwkh);
reg_file->item[FME0].reg[FME0_RESERVE10].bitwidth                    = 0;
reg_file->item[FME0].reg[FME0_RESERVE10].index                       = FME0_RESERVE10;
reg_file->item[FME0].reg[FME0_RESERVE10].phy_addr                    = &(andla_fme0_reg_p->reserve10);
reg_file->item[FME0].reg[FME0_RESERVE11].bitwidth                    = 0;
reg_file->item[FME0].reg[FME0_RESERVE11].index                       = FME0_RESERVE11;
reg_file->item[FME0].reg[FME0_RESERVE11].phy_addr                    = &(andla_fme0_reg_p->reserve11);
reg_file->item[FME0].reg[FME0_RESERVE12].bitwidth                    = 0;
reg_file->item[FME0].reg[FME0_RESERVE12].index                       = FME0_RESERVE12;
reg_file->item[FME0].reg[FME0_RESERVE12].phy_addr                    = &(andla_fme0_reg_p->reserve12);
reg_file->item[FME0].reg[FME0_OM_OW].bitwidth                        = 14;
reg_file->item[FME0].reg[FME0_OM_OW].index                           = FME0_OM_OW;
reg_file->item[FME0].reg[FME0_OM_OW].phy_addr                        = &(andla_fme0_reg_p->om_ow);
reg_file->item[FME0].reg[FME0_OM_OH].bitwidth                        = 14;
reg_file->item[FME0].reg[FME0_OM_OH].index                           = FME0_OM_OH;
reg_file->item[FME0].reg[FME0_OM_OH].phy_addr                        = &(andla_fme0_reg_p->om_oh);
reg_file->item[FME0].reg[FME0_OM_OC].bitwidth                        = 14;
reg_file->item[FME0].reg[FME0_OM_OC].index                           = FME0_OM_OC;
reg_file->item[FME0].reg[FME0_OM_OC].phy_addr                        = &(andla_fme0_reg_p->om_oc);
reg_file->item[FME0].reg[FME0_IM_ADDR_INIT].bitwidth                 = ANDLA_IBMC_ADDR_BITWIDTH;
reg_file->item[FME0].reg[FME0_IM_ADDR_INIT].index                    = FME0_IM_ADDR_INIT;
reg_file->item[FME0].reg[FME0_IM_ADDR_INIT].phy_addr                 = &(andla_fme0_reg_p->im_addr_init);
reg_file->item[FME0].reg[FME0_KR_ADDR_INIT].bitwidth                 = 19;
reg_file->item[FME0].reg[FME0_KR_ADDR_INIT].index                    = FME0_KR_ADDR_INIT;
reg_file->item[FME0].reg[FME0_KR_ADDR_INIT].phy_addr                 = &(andla_fme0_reg_p->kr_addr_init);
reg_file->item[FME0].reg[FME0_BS_ADDR_INIT].bitwidth                 = 19;
reg_file->item[FME0].reg[FME0_BS_ADDR_INIT].index                    = FME0_BS_ADDR_INIT;
reg_file->item[FME0].reg[FME0_BS_ADDR_INIT].phy_addr                 = &(andla_fme0_reg_p->bs_addr_init);
reg_file->item[FME0].reg[FME0_PL_ADDR_INIT].bitwidth                 = 19;
reg_file->item[FME0].reg[FME0_PL_ADDR_INIT].index                    = FME0_PL_ADDR_INIT;
reg_file->item[FME0].reg[FME0_PL_ADDR_INIT].phy_addr                 = &(andla_fme0_reg_p->pl_addr_init);
reg_file->item[FME0].reg[FME0_EM_ADDR_INIT].bitwidth                 = 19;
reg_file->item[FME0].reg[FME0_EM_ADDR_INIT].index                    = FME0_EM_ADDR_INIT;
reg_file->item[FME0].reg[FME0_EM_ADDR_INIT].phy_addr                 = &(andla_fme0_reg_p->em_addr_init);
reg_file->item[FME0].reg[FME0_OM_ADDR_INIT].bitwidth                 = 19;
reg_file->item[FME0].reg[FME0_OM_ADDR_INIT].index                    = FME0_OM_ADDR_INIT;
reg_file->item[FME0].reg[FME0_OM_ADDR_INIT].phy_addr                 = &(andla_fme0_reg_p->om_addr_init);
reg_file->item[FME0].reg[FME0_IM_ALIGNMENT_ICIW].bitwidth            = 19;
reg_file->item[FME0].reg[FME0_IM_ALIGNMENT_ICIW].index               = FME0_IM_ALIGNMENT_ICIW;
reg_file->item[FME0].reg[FME0_IM_ALIGNMENT_ICIW].phy_addr            = &(andla_fme0_reg_p->im_alignment_iciw);
...
reg_file->item[FME0].reg[FME0_OM_ALIGNMENT_OCOW].phy_addr            = &(andla_fme0_reg_p->om_alignment_ocow);
...
reg_file->item[FME0].reg[FME0_ALIGNMENT_KCKWKH].phy_addr             = &(andla_fme0_reg_p->alignment_kckwkh);
...
reg_file->item[FME0].reg[FME0_ALIGNMENT_KCKW].phy_addr               = &(andla_fme0_reg_p->alignment_kckw);
reg_file->item[FME0].reg[FME0_SC_ADDR_INIT].bitwidth                 = 19;
reg_file->item[FME0].reg[FME0_SC_ADDR_INIT].index                    = FME0_SC_ADDR_INIT;
reg_file->item[FME0].reg[FME0_SC_ADDR_INIT].phy_addr                 = &(andla_fme0_reg_p->sc_addr_init);
reg_file->item[FME0].reg[FME0_SH_ADDR_INIT].bitwidth                 = 19;
reg_file->item[FME0].reg[FME0_SH_ADDR_INIT].index                    = FME0_SH_ADDR_INIT;
reg_file->item[FME0].reg[FME0_SH_ADDR_INIT].phy_addr                 = &(andla_fme0_reg_p->sh_addr_init);
reg_file->item[FME0].reg[FME0_RESERVE28].bitwidth                    = 0;
reg_file->item[FME0].reg[FME0_RESERVE28].index                       = FME0_RESERVE28;
reg_file->item[FME0].reg[FME0_RESERVE28].phy_addr                    = &(andla_fme0_reg_p->reserve28);
reg_file->item[FME0].reg[FME0_EW_OP_EXT0].bitwidth                   = 0;
reg_file->item[FME0].reg[FME0_EW_OP_EXT0].index                      = FME0_EW_OP_EXT0;
reg_file->item[FME0].reg[FME0_EW_OP_EXT0].phy_addr                   = &(andla_fme0_reg_p->ew_op_ext0);
reg_file->item[LDMA2].reg[LDMA2_MODE_CTRL].bitwidth                  = 0;
reg_file->item[LDMA2].reg[LDMA2_MODE_CTRL].index                     = LDMA2_MODE_CTRL;
reg_file->item[LDMA2].reg[LDMA2_MODE_CTRL].phy_addr                  = &(andla_ldma2_reg_p->mode_ctrl);
...
reg_file->item[LDMA2].reg[LDMA2_ROLL_IC_IW_W_PAD_SIZE].phy_addr      = &(andla_ldma2_reg_p->roll_ic_iw_w_pad_size);
...
reg_file->item[LDMA2].reg[LDMA2_ROLL_IC_KW_SIZE].phy_addr            = &(andla_ldma2_reg_p->roll_ic_kw_size);
...
reg_file->item[LDMA2].reg[LDMA2_ROLL_KR_STRIDE_W_SIZE].phy_addr      = &(andla_ldma2_reg_p->roll_kr_stride_w_size);
...
reg_file->item[LDMA2].reg[LDMA2_ROLL_PAD_W_LEFT_W_IC_SIZE].phy_addr  = &(andla_ldma2_reg_p->roll_pad_w_left_w_ic_size);
...
reg_file->item[LDMA2].reg[LDMA2_ROLL_PAD_W_RIGHT_W_IC_SIZE].phy_addr = &(andla_ldma2_reg_p->roll_pad_w_right_w_ic_size);
...
reg_file->item[LDMA2].reg[LDMA2_ROLL_PAD_H_SIZE].phy_addr            = &(andla_ldma2_reg_p->roll_pad_h_size);
reg_file->item[CDMA].reg[CDMA_SFENCE].bitwidth                       = 22;
reg_file->item[CDMA].reg[CDMA_SFENCE].index                          = CDMA_SFENCE;
reg_file->item[CDMA].reg[CDMA_SFENCE].phy_addr                       = &(andla_cdma_reg_p->sfence);
reg_file->item[CDMA].reg[CDMA_DIRECTION].bitwidth                    = 0;
reg_file->item[CDMA].reg[CDMA_DIRECTION].index                       = CDMA_DIRECTION;
reg_file->item[CDMA].reg[CDMA_DIRECTION].phy_addr                    = &(andla_cdma_reg_p->direction);
...
reg_file->item[CDMA].reg[CDMA_EXRAM_ADDR_LSB].phy_addr               = &(andla_cdma_reg_p->exram_addr_lsb);
...
reg_file->item[CDMA].reg[CDMA_EXRAM_ADDR_MSB].phy_addr               = &(andla_cdma_reg_p->exram_addr_msb);
reg_file->item[CDMA].reg[CDMA_EXRAM_C].bitwidth                      = 22;
reg_file->item[CDMA].reg[CDMA_EXRAM_C].index                         = CDMA_EXRAM_C;
reg_file->item[CDMA].reg[CDMA_EXRAM_C].phy_addr                      = &(andla_cdma_reg_p->exram_c);
reg_file->item[CDMA].reg[CDMA_EXRAM_W].bitwidth                      = 16;
reg_file->item[CDMA].reg[CDMA_EXRAM_W].index                         = CDMA_EXRAM_W;
reg_file->item[CDMA].reg[CDMA_EXRAM_W].phy_addr                      = &(andla_cdma_reg_p->exram_w);
...
reg_file->item[CDMA].reg[CDMA_EXRAM_STRIDE_W].phy_addr               = &(andla_cdma_reg_p->exram_stride_w);
